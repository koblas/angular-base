...
function diff_match_patch() {
    ...
    function d(e, t, n, i) {
        if (at.acceptData(e)) {
            var s, a, o = at.expando,
                ...
                c = r ? at.cache : e,
                l = r ? e[o] : e[o] && o;
            if (l && c[l] && (i || c[l].data) || void 0 !== n || "string" != typeof t) return l || (l = r ? e[o] = K.pop() || at.guid++ : o), c[l] || (c[l] = r ? {} : {
                toJSON: at.noop
    ...
    function L(e, t, n) {
        ...
        if (!at.isEmptyObject(h)) {
            ...
            for (i in h) o = O(f ? m[i] : 0, i, u), i in m || (m[i] = o.start, f && (o.end = o.start, o.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function j(e, t, n) {
        var i, s, a = 0,
            ...
            c = function () {
                if (s) return !1;
                for (var t = mn || F(), n = Math.max(0, l.startTime + l.duration - t), i = n / l.duration || 0, a = 1 - i, o = 0, c = l.tweens.length; c > o; o++) l.tweens[o].run(a);
            ...
            d = l.props;
        for ($(d, l.opts.specialEasing); o > a; a++)
            if (i = yn[a].call(l, e, d, l.opts)) return i;
        return at.map(d, O, l), at.isFunction(l.opts.start) && l.opts.start.call(e, l), at.fx.timer(at.extend(c, {
            elem: e,
            anim: l,
            queue: l.opts.queue
    ...
    function q(e, t, n, i) {
        ...
        if (at.isArray(t)) at.each(t, function (t, s) {
            n || Xn.test(e) ? i(e, s) : q(e + "[" + ("object" == typeof s ? t : "") + "]", s, n, i)
        });
    ...
    at.fn = at.prototype = {
        ...
        proxy: function (e, t) {
            var n, i, s;
            return "string" == typeof t && (s = e[t], t = e, e = s), at.isFunction(e) ? (n = X.call(arguments, 2), i = function () {
    ...
    function (e) {
        function t(e, t, n, i) {
            ...
            if (R && !i) {
                ...
                if (T.qsa && (!O || !O.test(e))) {
                    if (f = u = P, m = t, v = 9 === r && e, 1 === r && "object" !== t.nodeName.toLowerCase()) {
        ...
        function f(e, t, n) {
            ...
            return t.first ? function (t, n, a) {
                ...
                if (o) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || s) {
                            if (c = t[P] || (t[P] = {}), (r = c[i]) && r[0] === H && r[1] === a) return l[2] = r[2];
        ...
        function g(e, t, n, s, a, o) {
            return s && !s[P] && (s = g(s)), a && !a[P] && (a = g(a, o)), i(function (i, o, r, c) {
                var l, d, u, h = [],
                    p = [],
                    f = o.length,
        ...
        function _(e) {
            for (var t, n, i, s = e.length, a = C.relative[e[0].type], o = a || C.relative[" "], r = a ? 1 : 0, c = f(function (e) {
                ...
                if (n = C.relative[e[r].type]) d = [f(m(d), n)];
                    ...
                    if (n = C.filter[e[r].type].apply(null, e[r].matches), n[P]) {
        ...
        function w(e, t, n, i) {
            var s, a, o, r, c, l = h(e);
            if (!i && 1 === l.length) {
                if (a = l[0] = l[0].slice(0), a.length > 2 && "ID" === (o = a[0]).type && T.getById && 9 === t.nodeType && R && C.relative[a[1].type]) {
            ...
            return M(e, l)(i, t, !R, n, bt.test(e) && d(t.parentNode) || t), n
        }
        var x, T, C, S, k, M, E, D, N, A, I, F, R, O, L, $, j, P = "sizzle" + -new Date,
            B = e.document,
            H = 0,
            U = 0,
            V = n(),
        ...
        T = t.support = {}, k = t.isXML = function (e) {
            ...
            var t, n = e ? e.ownerDocument || e : B,
                i = n.defaultView;
            return n !== I && 9 === n.nodeType && n.documentElement ? (I = n, F = n.documentElement, R = !k(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function () {
                A()
                ...
                return F.appendChild(e).id = P, !n.getElementsByName || !n.getElementsByName(P).length
            ...
            }, L = [], O = [], (T.qsa = gt.test(n.querySelectorAll)) && (s(function (e) {
            ...
            })), (T.matchesSelector = gt.test($ = F.webkitMatchesSelector || F.mozMatchesSelector || F.oMatchesSelector || F.msMatchesSelector)) && s(function (e) {
                T.disconnectedMatch = $.call(e, "div"), $.call(e, "[s!='']:x"), L.push("!=", rt)
            }), O = O.length && new RegExp(O.join("|")), L = L.length && new RegExp(L.join("|")), t = gt.test(F.compareDocumentPosition), j = t || gt.test(F.contains) ? function (e, t) {
                ...
                return i ? i : (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & i || !T.sortDetached && t.compareDocumentPosition(e) === i ? e === n || e.ownerDocument === B && j(B, e) ? -1 : t === n || t.ownerDocument === B && j(B, t) ? 1 : D ? tt.call(D, e) - tt.call(D, t) : 0 : 4 & i ? -1 : 1)
            } : function (e, t) {
                if (e === t) return N = !0, 0;
                var i, s = 0,
                    a = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== I && A(e), n = n.replace(ut, "='$1']"), !(!T.matchesSelector || !R || L && L.test(n) || O && O.test(n))) try {
                var i = $.call(e, n);
            ...
            var n = C.attrHandle[t.toLowerCase()],
                i = n && X.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !R) : void 0;
            ...
            var t, n = [],
                i = 0,
                s = 0;
            if (N = !T.detectDuplicates, D = !T.sortStable && e.slice(0), e.sort(W), N) {
            ...
            filter: {
                    ...
                    return 1 === i && 0 === s ? function (e) {
                        ...
                        if (v) {
                            ...
                            if (f = [o ? v.firstChild : v.lastChild], o && _) {
                                for (d = v[P] || (v[P] = {}), l = d[e] || [], p = l[0] === H && l[1], h = l[0] === H && l[2], u = p && v.childNodes[p]; u = ++p && u && u[m] || (h = p = 0) || f.pop();)
                                    if (1 === u.nodeType && ++h && u === t) {
                                        d[e] = [H, p, h];
                                        break
                                    }
                            } else if (_ && (l = (t[P] || (t[P] = {}))[e]) && l[0] === H) h = l[1];
                            else
                                for (;
                                    (u = ++p && u && u[m] || (h = p = 0) || f.pop()) && ((r ? u.nodeName.toLowerCase() !== g : 1 !== u.nodeType) || !++h || (_ && ((u[P] || (u[P] = {}))[e] = [H, h]), u !== t)););
                ...
                PSEUDO: function (e, n) {
                    ...
                    return a[P] ? a(n) : a.length > 1 ? (s = [e, e, "", n], C.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, t) {
        ...
        return u.prototype = C.filters = C.pseudos, C.setFilters = new u, M = t.compile = function (e, t) {
            var n, i = [],
                ...
                a = z[e + " "];
            if (!a) {
                for (t || (t = h(e)), n = t.length; n--;) a = _(t[n]), a[P] ? i.push(a) : s.push(a);
                a = z(e, b(s, i))
            }
            return a
        }, T.sortStable = P.split("").sort(W).join("") === P, T.detectDuplicates = !! N, A(), T.sortDetached = s(function (e) {
    ...
    at.Callbacks = function (e) {
        ...
        when: function (e) {
            var t, n, i, s = 0,
                ...
                l = function (e, n, i) {
                    return function (s) {
                        n[e] = this, i[e] = arguments.length > 1 ? X.call(arguments) : s, i === t ? c.notifyWith(n, i) : --r || c.resolveWith(n, i)
                    }
                };
            if (o > 1)
    ...
    at.event = {
        ...
        add: function (e, t, n, i, s) {
            ...
            if (v) {
                ...
                }, d.elem = e), t = (t || "").match(yt) || [""], r = t.length; r--;) a = Lt.exec(t[r]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p && (l = at.event.special[p] || {}, p = (s ? l.delegateType : l.bindType) || p, l = at.event.special[p] || {}, u = at.extend({
                    type: p,
                    origType: m,
                    data: i,
                    handler: n,
        ...
        remove: function (e, t, n, i, s) {
            ...
            if (v && (d = v.events)) {
                for (t = (t || "").match(yt) || [""], l = t.length; l--;)
                    if (r = Lt.exec(t[l]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p) {
        ...
        trigger: function (t, n, i, s) {
            ...
            if (r = d = i = i || mt, 3 !== i.nodeType && 8 !== i.nodeType && !Ot.test(p + at.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), o = p.indexOf(":") < 0 && "on" + p, t = t[at.expando] ? t : new at.Event(p, "object" == typeof t && t), t.isTrigger = s ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : at.makeArray(n, [t]), l = at.event.special[p] || {}, s || !l.trigger || l.trigger.apply(i, n) !== !1)) {
                if (!s && !l.noBubble && !at.isWindow(i)) {
                    for (c = l.delegateType || p, Ot.test(c + p) || (r = r.parentNode); r; r = r.parentNode) h.push(r), d = r;
        ...
        fix: function (e) {
            ...
            var t, n, i, s = e.type,
                a = e,
                o = this.fixHooks[s];
            for (o || (this.fixHooks[s] = o = Rt.test(s) ? this.mouseHooks : Ft.test(s) ? this.keyHooks : {}), i = o.props ? this.props.concat(o.props) : this.props, e = new at.Event(a), t = i.length; t--;) n = i[t], e[n] = a[n];
    ...
    Jt.optgroup = Jt.option, Jt.tbody = Jt.tfoot = Jt.colgroup = Jt.caption = Jt.thead, Jt.th = Jt.td, at.extend({
        clone: function (e, t, n) {
            ...
            if (it.html5Clone || at.isXMLDoc(e) || !Pt.test("<" + e.nodeName + ">") ? a = e.cloneNode(!0) : (Gt.innerHTML = e.outerHTML, Gt.removeChild(a = Gt.firstChild)), !(it.noCloneEvent && it.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || at.isXMLDoc(e)))
        ...
        cleanData: function (e, t) {
            for (var n, i, s, a, o = 0, r = at.expando, c = at.cache, l = it.deleteExpando, d = at.event.special; null != (n = e[o]); o++)
                if ((t || at.acceptData(n)) && (s = n[r], a = s && c[s])) {
                    ...
                    c[s] && (delete c[s], l ? delete n[r] : typeof n.removeAttribute !== Ct ? n.removeAttribute(r) : n[r] = null, K.push(s))
                }
        }
    }), at.fn.extend({
        text: function (e) {
        ...
        html: function (e) {
            return Nt(this, function (e) {
                ...
                if (!("string" != typeof e || zt.test(e) || !it.htmlSerialize && Pt.test(e) || !it.leadingWhitespace && Bt.test(e) || Jt[(Ut.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Ht, "<$1></$2>");
                    try {
        ...
        domManip: function (e, t) {
            ...
            var n, i, s, a, o, r, c = 0,
                ...
                h = e[0],
                p = at.isFunction(h);
            if (p || l > 1 && "string" == typeof h && !it.checkClone && Wt.test(h)) return this.each(function (n) {
                var i = d.eq(n);
            ...
            if (l && (r = at.buildFragment(e, this[0].ownerDocument, !1, this), n = r.firstChild, 1 === r.childNodes.length && (r = n), n)) {
                ...
                if (s)
                    for (o = a[a.length - 1].ownerDocument, at.map(a, y), c = 0; s > c; c++) i = a[c], Qt.test(i.type || "") && !at._data(i, "globalEval") && at.contains(o, i) && (i.src ? at._evalUrl && at._evalUrl(i.src) : at.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Xt, "")));
                r = n = null
            }
            return this
        }
    ...
    at.Animation = at.extend(j, {
        ...
        at.fn[t] = function (e, i, s) {
            return null == e || "boolean" == typeof e ? n.apply(this, arguments) : this.animate(R(t, !0), e, i, s)
        }
    }), at.each({
        slideDown: R("show"),
        slideUp: R("hide"),
    ...
    at.parseJSON = function (t) {
        ...
        var n, i = null,
            s = at.trim(t + "");
        return s && !at.trim(s.replace(Rn, function (e, t, s, a) {
    ...
    On = Vn.exec(Ln.toLowerCase()) || [], at.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, t) {
            ...
            var i, s, a, o, r, c, l, d, u = at.ajaxSetup({}, t),
                ...
                w = {
                    ...
                    getResponseHeader: function (e) {
                        ...
                        if (2 === b) {
                            if (!d)
                                for (d = {}; t = Pn.exec(o);) d[t[1].toLowerCase()] = t[2];
                            t = d[e.toLowerCase()]
                        }
            ...
            if (f.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, u.url = ((e || u.url || Ln) + "").replace($n, "").replace(Un, On[1] + "//"), u.type = t.method || t.type || u.method || u.type, u.dataTypes = at.trim(u.dataType || "*").toLowerCase().match(yt) || [""], null == u.crossDomain && (i = Vn.exec(u.url.toLowerCase()), u.crossDomain = !(!i || i[1] === On[1] && i[2] === On[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (On[3] || ("http:" === On[1] ? "80" : "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = at.param(u.data, u.traditional)), B(qn, u, t, w), 2 === b) return w;
            c = u.global, c && 0 === at.active++ && at.event.trigger("ajaxStart"), u.type = u.type.toUpperCase(), u.hasContent = !Hn.test(u.type), a = u.url, u.hasContent || (u.data && (a = u.url += (Fn.test(a) ? "&" : "?") + u.data, delete u.data), u.cache === !1 && (u.url = jn.test(a) ? a.replace(jn, "$1_=" + In++) : a + (Fn.test(a) ? "&" : "?") + "_=" + In++)), u.ifModified && (at.lastModified[a] && w.setRequestHeader("If-Modified-Since", at.lastModified[a]), at.etag[a] && w.setRequestHeader("If-None-Match", at.etag[a])), (u.data && u.hasContent && u.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", u.contentType), w.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + ("*" !== u.dataTypes[0] ? ", " + Wn + "; q=0.01" : "") : u.accepts["*"]);
    ...
    at.ajaxSetup({
        ...
        return r || "jsonp" === t.dataTypes[0] ? (s = t.jsonpCallback = at.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, r ? t[r] = t[r].replace(ii, "$1" + s) : t.jsonp !== !1 && (t.url += (Fn.test(t.url) ? "&" : "?") + t.jsonp + "=" + s), t.converters["script json"] = function () {
...
function () {
    ...
    T.each(["escape", "unescape"], function (e) {
        ...
        C(T.functions(e), function (t) {
            ...
            T.prototype[t] = function () {
                var e = [this._wrapped];
                return o.apply(e, arguments), j.call(this, n.apply(T, e))
            }
        })
    };
    var R = 0;
    ...
    T.template = function (e, t, n) {
        ...
        var s = new RegExp([(n.escape || O).source, (n.interpolate || O).source, (n.evaluate || O).source].join("|") + "|$", "g"),
            a = 0,
            o = "__p+='";
        e.replace(s, function (t, n, i, s, r) {
            return o += e.slice(a, r).replace($, function (e) {
                return "\\" + L[e]
...
function () {
    ...
    a.extend(u.prototype, o, {
        ...
        save: function (e, t, n) {
            ...
            }, L(this, n), s = this.isNew() ? "create" : n.patch ? "patch" : "update", "patch" === s && (n.attrs = i), o = this.sync(s, this, n), i && n.wait && (this.attributes = r), o
        },
        destroy: function (e) {
            e = e ? a.clone(e) : {};
            var t = this,
    ...
    a.extend(_.prototype, o, {
        ...
        if (n.url || (o.url = a.result(t, "url") || O()), null != n.data || !t || "create" !== e && "update" !== e && "patch" !== e || (o.contentType = "application/json", o.data = JSON.stringify(n.attrs || t.toJSON(n))), n.emulateJSON && (o.contentType = "application/x-www-form-urlencoded", o.data = o.data ? {
            model: o.data
    ...
    u.extend = p.extend = T.extend = _.extend = E.extend = R;
    var O = function () {
...
}(this, jQuery, tide.util), tide.util.tooltips = function (e) {
...
function (e, t) {
    var n = 5,
        ...
        o = 5,
        r = 400;
    tide.v.View.extend("Tooltip", {
        init: function (e) {
            tide.v.View.prototype.init.call(this, e), this._setVisible(!1), this.$element.remove(), this.displayContext = null, this._boundMouseOutHandler = t.proxy(this, "_mouseOutHandler")
        },
        setText: function (e) {
            this.$content.text(e)
        },
        setContent: function (e) {
            this.$content.empty().append(e)
        },
        setHtml: function (e) {
            this.$content.html(e)
        },
        attachTo: function (e, r) {
            r = r || "bottom";
            var c = e.element || e,
                l = c.getBoundingClientRect(),
                d = window.innerWidth,
                u = window.innerHeight,
                h = tide.util.measureElement(this.element),
                p = {
                    top: l.top - o - a,
                    bottom: u - l.bottom - o - a,
                    left: l.left - o - a,
                    right: d - l.right - o - a
                };
            "top" === r ? p.top < h.height && p.top < p.bottom && (r = "bottom") : "bottom" === r && p.bottom < h.height && p.bottom < p.top && (r = "top");
            var f = l.left + l.width / 2,
                m = "top" === r ? l.top - o : l.bottom + o,
                v = h.width / 2,
                g = "top" === r ? h.height + i : 0,
                _ = f - v,
                b = "top" === r ? m - h.height : m;
            a > _ ? (_ = a, v = Math.max(f - _, s)) : _ + h.width > d - a && (_ = d - a - h.width, v = Math.min(f - _, h.width - s)), a > b ? b = a : b + h.height > u - a && (b = u - a - h.height);
            var y = this.displayContext || this._findContext(t(c));
            if (y) {
                this.element.style.position = "absolute";
                var w = y.getBoundingClientRect();
                _ -= w.left, b -= w.top
            } else this.element.style.position = "fixed";
            var x = {
                top: "bottom",
                bottom: "top",
                left: "right",
            ...
            this.$pointer.addClass(x), this.$pointer.css({
                left: v - n + "px",
                top: g - i + "px"
            }), this.setPosition(_, b)
        },
        ...
        show: function (e, t) {
            this._hideCancelled = !0, e && this.attachTo(e, t), this.visible || (tide.v.Tooltip.hideVisibleTips(), tide.v.Tooltip.visibleTips.push(this), this.appendTo(this.displayContext || document.body), this.element.offsetLeft, tide.v.View.prototype.show.call(this), this.$element.on("mouseout", this._boundMouseOutHandler))
        },
        hide: function (e) {
            if (e = e !== !1, this.visible) {
                if (this._hideCancelled = !0, e) {
                    var t = this;
                    this.$element.on(tide.util.transitionEvent, function () {
                        t.visible || t.$element.remove()
                    })
                }
                tide.v.View.prototype.hide.call(this), e || this.$element.remove()
            }
        },
        scheduleHide: function (e) {
            e = e || r, this._hideCancelled = !1;
            var t = this,
                n = function () {
                    t.$element.off("mouseover", n), t._hideCancelled = !0
                };
            this.$element.on("mouseover", n), setTimeout(function () {
                t._hideCancelled || t.hide()
            }, e)
        },
        _mouseOutHandler: function (e) {
            var t = e.toElement || e.relatedTarget;
            if (t) {
                var n = this.element.compareDocumentPosition(t),
                    i = n & this.element.DOCUMENT_POSITION_CONTAINED_BY;
                i || this.scheduleHide()
            }
        },
        _findContext: function (e) {
            for (var t = e, n = null; t[0] !== n;) {
                if ("fixed" === t.css("position")) return null;
                n = t[0], t = t.offsetParent()
            }
        ...
        _createElement: function () {
            ...
            n.className = "tooltip-inner", this.$content = t(n), e.appendChild(n);
            var i = document.createElement("div");
            return i.className = "tooltip-pointer", this.$pointer = t(i), e.appendChild(i), e
        },
        _setupElement: function () {
            if (tide.v.View.prototype._setupElement.call(this), this.$content = this.$element.find(".tooltip-inner")[0], this.$pointer = this.$element.find(".tooltip-pointer"), !this.$pointer.length) {
                var e = document.createElement("div");
                e.className = "tooltip-pointer", this.element.appendChild(e), this.$pointer = t(e)
            }
        }
    }, {
        CSS_CLASS: "tooltip view",
        get: function () {
            return new tide.v.Tooltip
        },
        visibleTips: [],
        hideVisibleTips: function () {
            for (var e = this.visibleTips.slice(), t = e.length - 1; t > -1; t--) e[t].hide()
        }
    })
}(this, jQuery),
function (e) {
...
function (e, t) {
    function n() {
        var a = "scrollTop" in e.document.body ? e.document.body.scrollTop : e.document.documentElement.scrollTop;
        a !== t && a > 0 && e.document.body && (e.document.body.insertBefore(s, e.document.body.firstChild), s.getBoundingClientRect && 0 === s.getBoundingClientRect().top || (e.document.documentElement.className = e.document.documentElement.className.replace(i, "")), e.document.body.removeChild(s), e.removeEventListener ? e.removeEventListener("scroll", n, !1) : e.detachEvent("onscroll", n))
    }
    var i = "fixed-supported",
        s = e.document.createElement("div"),
        a = e.navigator.userAgent;
    s.style.position = "fixed", s.style.top = 0, a.match(/Android 2\.[1256]/) && a.indexOf("AppleWebKit") > -1 && a.match(/Opera Mobi\/([0-9]+)/) && RegExp.$1 < 7458 && e.operamini && "[object OperaMini]" === {}.toString.call(e.operamini) && a.match(/Fennec\/([0-9]+)/) && RegExp.$1 < 6 || (e.document.documentElement.className += " " + i, e.addEventListener ? e.addEventListener("scroll", n, !1) : e.attachEvent("onscroll", n))
}(this);
/*
 * SVGeezy.js 1.0
 *
...
function (e) {
    function t(e) {
        ...
        if (t >= a) {
            var c = s - e;
            if (3e5 > c) return "Just now";
            if (36e5 > c) return Math.round(c / 6e4) + " minutes ago";
            var l = Math.round(c / 36e5);
            return 1 === l ? "An hour ago" : l + " hours ago"
        }
        return t >= o ? "Yesterday" : t >= r ? Math.ceil((a - t) / 864e5) + " days ago" : i[e.getMonth()] + " " + e.getDate() + ", " + e.getFullYear()
    }

    function n(e, t) {
        return t = t || 0, new Date(e.getFullYear(), e.getMonth(), e.getDate() + t)
    }
    var i = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    return e.tinyDateString = t
}(tide),
function (e) {
    "use strict";
...
function (e, t, n, i, s, a, o, r) {
    var c = SMT["articles/document_grid_cell"];
    t.v.DocumentCardView = o.extend({
        events: {
            "change .status-picker li input": "statusChanged"
        },
        initialize: function (e) {
            e = e || {}, this.appState = e.appState, e.model || (this.model = a.get(parseInt(this.$el.data("article-id"), 10))), this.taggable = this.model, e.el ? this.$(".select-menu .current-page").not(".collapsible-heading").collapsible() : this.render(), this.timestampUpdater = setInterval(s.bind(this.updateTimestamps, this), 6e4)
        },
        remove: function () {
            return clearInterval(this.timestampUpdater), o.prototype.remove.apply(this, arguments)
        },
        render: function () {
            var e = this.model,
                s = this._statusData(),
                a = {
                    can_haz_tags: t.config.tags,
                    article_id: e.id,
                    title: e.get("title"),
                    archived: e.get("archived"),
                    updated_at_dt: e.get("updated_at"),
                    updated_at_human: n(e.get("updated_at")),
                    user_name: e.get("owner").short_name,
                    last_updated_user: e.get("updated_by"),
                    editor_path: "/docs/" + e.id,
                    can_edit: e.get("permissions").edit,
                    is_owner: e.get("owner").id === this.appState.get("user").id,
                    has_tags: e.tags.length > 0,
                    has_unread: e.unread.documentActivity().length || e.unread.isDiscussionUnread(),
                    status: s.text,
                    status_class: "doc-status-" + s.downcased,
                    status_downcase: s.downcased,
                    status_options: this.appState.statusesForDocument(e)
                }, o = i(c(a));
            this.setElement(o), this.$(".select-menu .current-page").not(".collapsible-heading").collapsible()
        },
        _statusData: function (e) {
            return e = e || this.model.get("status_id"), s.findWhere(this.appState.get("space").statuses, {
                id: e
            })
        },
        updateTimestamps: function () {
            var e = n(this.model.get("updated_at"));
            this.$(".when time").text(e)
        },
        statusChanged: function (e) {
            var t = e.target,
                n = parseInt(t.value, 10),
                s = this._statusData(),
                a = this._statusData(n);
            this.model.save({
                status_id: n
            }, {
                patch: !0
            });
            var o = "doc-" + t.parentNode.className;
            this.el.className = this.el.className.replace(/doc\-status\-[a-z]+/, o);
            var r = this.$(".doc-status-bubble");
            r.length && (r[0].className = r[0].className.replace(/doc\-status\-[ac-z]+/, o));
            var c = i(t).closest(".select-menu").find(".collapsible-heading");
            c.removeClass("status-" + s.downcased).addClass("status-" + a.downcased).trigger("collapse").find(".status-text").text(a.text)
        }
    }), e.mixin(t.v.DocumentCardView, r)
}(Cocktail, this.tide, tide.tinyDateString, jQuery, _, tide.m.Document, tide.v.BBView, tide.Tagging),
function (e, t, n, i, s, a, o) {
    var r = SMT["articles/dashboard_tag"],
        c = SMT["articles/dashboard_tag_edit"],
        l = "tag-list-edit",
        d = "editing";
    e.v.ManageTagsView = o.extend({
        template: SMT["articles/dashboard_tags"],
        events: {
            "TOUCH_END .manage-tags": "toggleEditing",
            "TOUCH_END .save-tags": "toggleEditing",
            "TOUCH_END .delete-tag": "deleteTag",
            "TOUCH_END .undelete-tag": "undeleteTag",
            "input input": "editTag",
            "change input": "editTag",
            "TOUCH_END .tag a": "tapTag"
        },
        initialize: function (e) {
            this.editing = !1, this.edits = {}, this.removals = {}, this.appState = e && e.appState, this.listenTo(this.collection, "add", this.addedTag), this.listenTo(this.collection, "remove", this.removedTag), this.listenTo(this.collection, "change", this.changedTag), this.listenTo(s, "taggedDocument", this.taggedDocument), this.listenTo(s, "untaggedDocument", this.untaggedDocument), this.listenTo(this.appState.get("space").filter, "change:tags", this.filterChanged)
        },
        render: function () {
            var e = i(this.template({}))[0];
            this.setElement(e), this.renderTags()
        },
        renderTags: function () {
            var e = this.collection.map(this.renderTag, this);
            this.$(".tag-list").html(e.join(""))
        },
        renderTag: function (e) {
            var t = this.appState.get("space").filter,
                n = e.toJSON();
            n.filter_url = t.addedFilterUrl({
                tag: e.get("name")
            }), n.active = t.tagIsActive(e);
            var i = this.editing ? c : r,
                s = i(n);
            return s
        },
        addedTag: function (e) {
            var t = this.$("[data-id='" + e.id + "']");
            t.length || this.$(".tag-list").append(r(e.toJSON()))
        },
        removedTag: function (e) {
            this.$("[data-id='" + e.id + "']").remove()
        },
        changedTag: function (e) {
            this.$("[data-id='" + e.id + "']").replaceWith(r(e.toJSON()))
        },
        taggedDocument: function (e) {
            var t = this.collection.get(e.id);
            t ? t.set("count", t.get("count") + 1) : this.collection.add({
                id: e.id,
                name: e.get("name"),
                count: 1
            })
        },
        untaggedDocument: function (e) {
            var t = this.collection.get(e.id);
            if (t) {
                var n = t.get("count") - 1;
                n ? t.set("count", n) : this.collection.remove(t)
            }
        },
        tagRoot: function (e) {
            return i(e).closest(".tag")
        },
        tagForElement: function (e) {
            var t = parseInt(this.tagRoot(e).data("id"), 10);
            return this.collection.get(t)
        },
        toggleEditing: function (e) {
            e && e.preventDefault(), this.editing = !this.editing;
            var t = this.$(".tag-list");
            t.toggleClass(l, this.editing), this.$el.toggleClass(d, this.editing), this.editing || this.saveChanges(), this.renderTags()
        },
        deleteTag: function (e) {
            e.preventDefault();
            var t = this.tagForElement(e.target);
            this.removals[t.id] = !0, this.tagRoot(e.target).addClass("deleted").find("input").prop("disabled", !0)
        },
        undeleteTag: function (e) {
            e.preventDefault();
            var t = this.tagForElement(e.target);
            delete this.removals[t.id], this.tagRoot(e.target).removeClass("deleted").find("input").prop("disabled", !1)
        },
        editTag: function (e) {
            var t = this.tagForElement(e.target);
            this.edits[t.id] = e.target.value
        },
        saveChanges: function () {
            _.forEach(this.removals, function (e, t) {
                var n = this.collection.get(t);
                n && (n.destroy(), s.trigger("deletedTag", n, this))
            }, this), _.forEach(this.edits, function (e, t) {
                var n = this.collection.get(t);
                if (n) {
                    var i = n.get("name");
                    n.save({
            ...
            }, this), this.edits = {}, this.removals = {}
        },
        tapTag: function (e) {
            if (!this.editing) {
                e.preventDefault();
                var t = this.tagForElement(e.target);
                this.appState.get("space").filter.toggleTag(t)
            }
        },
    ...
    var u = t.touchEvents ? "touchend" : "click";
    _.each(e.v.ManageTagsView.prototype.events, function (e, t, n) {
        0 === t.indexOf("TOUCH_END") && (delete n[t], n[t.replace("TOUCH_END", u)] = e)
    })
}(this.tide, tide.support, tide.util, jQuery, Backbone, tide.m.Tags, tide.v.BBView),
function (e) {
    e.v.ManageTagsMenuView = e.v.ManageTagsView.extend({
        template: SMT["navigation/navigation_dash_small_tags"]
    })
}(this.tide, tide.v.ManageTagsView),
function (e, t, n, i, s, a, o) {
    var r = SMT["navigation/navigation_dash_small_filter"],
        c = SMT["navigation/navigation_dash_small_sort"],
        l = [{
            id: "updated_at",
            text: "Date modified"
        }, {
        ...
        d = s.extend({
            template: SMT["navigation/navigation_dash_small_screen"],
            className: "menu-container",
            events: {
                "TOUCH_END .new-document": "tapNewDocument",
                "TOUCH_END .filter-your-docs": "tapFilterYourDocs",
                "TOUCH_END .filter-status": "showStatuses",
                "TOUCH_END .filter-sort": "showSort",
                "TOUCH_END .filter-tags": "showTags",
                "change .checked-menu input": "changeFilter",
                "TOUCH_END .back-to-main": "showMain"
            },
            initialize: function (e) {
                e = e || {}, this.page = e.page || "generic", this.visible = !1, this.appState = e.appState, this.tags = e.tags, this.$edOuter = $(".ed-outer"), this.render(null, this.viewModel()), this.$sub = this.$(".sub-menu-panel"), this.updateFilters(), this.listenTo(this.appState.get("space").filter, "change", this.updateFilters)
            },
            viewModel: function () {
                var e = {
                    filter: this.appState.get("space").filter.toJSON(),
                    status_options: this.appState.statusesForFilter(),
                    sort_options: this._sortForRender(),
                    user: this.appState.get("user").toJSON()
                };
                return e["page_" + this.page] = !0, e
            },
            toggleVisible: function () {
                this.visible ? (this.$el.removeClass("open"), this.$edOuter.removeClass("ed-menu-open"), this.visible = !1) : (this.$el.addClass("open"), this.$edOuter.addClass("ed-menu-open"), this.visible = !0)
            },
            updateFilters: function () {
                var e = this.appState.get("space").filter;
                this.$(".filter-your-docs").closest("li").toggleClass("selected", e.get("owner_only"));
                var t = (e.get("status") || "all").toString();
                this.updateCheckedMenu("status", t), this.updateCheckedMenu("sort", e.get("order"))
            },
            updateCheckedMenu: function (e, t) {
                var n;
                this.$(".checked-menu [name=" + e + "]").each(function (e, i) {
                    var s = i.value === t;
                    i.checked = s;
                    var a = $(i).closest("li").toggleClass("selected", s);
                    s && (n = a)
                })
            },
            slideIn: function (t) {
                var n = this;
                t.call(this), e.util.transitionEvent && this.$sub.off(e.util.transitionEvent), setTimeout(function () {
                    n.$sub.addClass("open"), n.$el.addClass("submenu-focused").removeClass("menu-focused"), n.$el[0].scrollTop = 0
                }, 1)
            },
            tapFilterYourDocs: function (e) {
                e.preventDefault();
                var t = this.appState.get("space").filter;
                t.set("owner_only", !t.get("owner_only"))
            },
            tapNewDocument: function (t) {
                e.support.xhr2 && (new a({
                    el: "div.bb-modal"
            ...
            showMain: function (t) {
                t && t.preventDefault();
                var n = this;
                this.$el.addClass("menu-focused").removeClass("submenu-focused"), this.$sub.removeClass("open"), e.util.transitionEvent ? this.$sub.off(e.util.transitionEvent).one(e.util.transitionEvent, function () {
                    n.$sub.empty()
                }) : this.$sub.empty()
            },
            showStatuses: function (e) {
                e.preventDefault(), this.slideIn(function () {
                    this.renderInto(this.$sub, r, this.viewModel())
                })
            },
            showSort: function (e) {
                e.preventDefault(), this.slideIn(function () {
                    this.renderInto(this.$sub, c, this.viewModel())
                })
            },
            showTags: function (e) {
                e.preventDefault(), this.slideIn(function () {
                    ...
                    e.render(), this.$sub.empty().append(e.el)
                })
            },
            changeFilter: function (e) {
                var t = e.target.name,
                    n = e.target.value;
                "status" === t ? this.appState.get("space").filter.set("status", parseInt(n, 10)) : "sort" === t && this.appState.get("space").filter.set("order", n), this.showMain()
            },
            _sortForRender: function (e) {
                return e = e || this.appState.get("space").filter.get("order"), _.map(l, function (t) {
                    return _.extend({
                        selected: t.id === e
                    }, t)
                })
        ...
        u = t.touchEvents ? "touchend" : "click";
    return _.each(d.prototype.events, function (e, t, n) {
        0 === t.indexOf("TOUCH_END") && (delete n[t], n[t.replace("TOUCH_END", u)] = e)
    }), e.v.DashboardMenu = d
}(tide, tide.support, tide.util, tide.m.User, tide.v.BBView, tide.v.DocumentCreateModal, tide.v.ManageTagsMenuView),
function (e, t, n, i, s) {
    "use strict";
    var a = n.touchEvents ? "touchend" : "click",
        o = 50;
    e.DisplaySideMenu = {
        events: {
            "TOUCH_END .dash-hamburger": "toggleMenu",
            "TOUCH_END .ed-page": "closeMenu"
        },
        initialize: function () {
            (this.menu || this.$(".dash-hamburger").length) && (this._resizeHandler = _.bind(this.handleResize, this), $(window).on("resize", this._resizeHandler), this.appState || (this.appState = new i), this.menu || (this.menu = new s({
                page: this.page,
        ...
        toggleMenu: function (e) {
            e.preventDefault(), this.menu.toggleVisible()
        },
        closeMenu: function (e) {
            t.isEventFrom(e, this.$(".dash-hamburger")) || this.menu.visible && this.menu.toggleVisible()
        },
        handleResize: function () {
            if (this.menu.visible) {
                var e = parseInt($(document.documentElement).css("font-size"), 10) || 16;
                window.innerWidth >= o * e && this.menu.toggleVisible()
            }
        }
    }, _.each(e.DisplaySideMenu.events, function (e, t, n) {
        0 === t.indexOf("TOUCH_END") && (delete n[t], n[t.replace("TOUCH_END", a)] = e)
    })
}(this.tide, tide.util, tide.support, tide.m.AppState, tide.v.DashboardMenu),
function (e, t, n, i, s, a, o, r, c, l, d, u, h, p, f) {
    function m(e, t, n, i) {
        function s() {
            var a = t.slice(c, c + e);
            n.call(i, a), c += e, c < t.length && (r = setTimeout(s, 100))
        }
        ...
        var r = 0,
            c = 0;
        return o.next = s, o.cancel = a, o.defer = function (e) {
            return r = setTimeout(s, e || 0), o
        }, o
    }

    function v(e) {
        var n = t(e.target).closest(".invite"),
            i = Number(n.data("docid")),
            s = Number(e.target.action.match(/\/(\d+)/)[1]);
        return {
            document: i,
            permission: s
        }
    ...
    function g(e, n) {
        ...
        var i = v(e);
        return t.ajax({
            url: tide.API_ROOT + "/article/" + i.document + "/collaborators/" + i.permission,
            method: "PUT",
            data: n
        })
    }
    tide.v.DashboardView = c.extend({
        events: {
            "change .filter-select input": "changeFilterDropdown",
            "change #my-docs": "changeFilters",
            TOUCH_END: "tap",
            "submit .invite [data-reject]": "rejectInvite",
            "submit .invite [data-accept]": "acceptInvite",
            "click .delete-document": "clickDeleteDom",
            "click .archive-document": "clickArchiveDom",
            "click .leave-document": "clickLeaveDom",
            "click .export-document": "clickExportDom"
        },
        initialize: function () {
            function e(e, n) {
                i.push(new l({
            ...
            var t = this.appState = new f;
            this.allDocuments = t.get("space").documents, this.shownDocuments = this.allDocuments.models.slice(), this.$(".filter-select .filter-header").collapsible(), this.listenTo(t.get("space").filter, "change", this.filterChanged);
            var n = t.get("space").tags;
            n && (this.listenTo(n, "add", this.tagsChanged), this.listenTo(n, "remove", this.tagsChanged), this.tagsList = new d({
                el: this.$(".col-tags")[0],
                collection: n,
                appState: t
            }));
            var i = this.cards = [],
                s = this.$(".doc-instance");
            s.slice(0, 15).each(e), setTimeout(function () {
                s.slice(15).each(e)
            }, 250), this.menu = new u({
                tags: n,
                page: "dashboard",
                appState: t
            }), this.$(".ed-outer").append(this.menu.el), this.gotDocuments = this.allDocuments.fetch()
        },
        clickDeleteDom: function (e) {
            var n = t(e.target).parents(".doc-instance"),
                i = n.attr("data-article-id"),
                s = n.attr("data-article-title");
            return this.clickDelete(i, s), !1
        },
        clickArchiveDom: function (e) {
            var n = t(e.target).parents(".doc-instance"),
                i = n.attr("data-article-id"),
                s = n.attr("data-article-title"),
                a = n.attr("data-article-archived");
            return this.clickArchive(i, s, a), !1
        },
        clickLeaveDom: function (e) {
            var n = t(e.target).parents(".doc-instance"),
                i = n.attr("data-article-id"),
                s = n.attr("data-article-title");
            return this.clickLeave(i, s), !1
        },
        clickExportDom: function (e) {
            var n = t(e.target).parents(".doc-instance"),
                i = n.attr("data-article-id"),
                s = n.attr("data-article-title");
            return this.clickExport(i, s), !1
        },
        setTagsListVisible: function (e) {
            var n = tide.util.transitionProperty;
            if (e.animate === !1) var i = document.body.style[n];
            t(document.body).toggleClass("empty-tags", !e.show), i && (document.body.offsetLeft, document.body.style[n] = i)
        },
        clickDelete: function (e, t) {
            var n = new tide.v.DeleteDocumentModal({
                el: "div.bb-modal",
                id: null
            });
            n.form_data.id = e, n.form_data.title = t, n.form_data.form_action = "/docs/" + e, n.show()
        },
        clickArchive: function (e, t, n) {
            var i = new tide.v.ArchiveDocumentModal({
                el: "div.bb-modal",
                id: null
            });
            i.form_data.archived = n, i.form_data.id = e, i.form_data.title = t, i.form_data.form_action = "/docs/" + e + "/archive", i.show()
        },
        clickLeave: function (e, t) {
            var n = new tide.v.LeaveDocumentModal({
                el: "div.bb-modal",
                id: null
            });
            n.form_data.id = e, n.form_data.title = t, n.form_data.form_action = "/collaborate/" + e + "/leave", n.show()
        },
        clickExport: function (e) {
            new tide.v.DocumentExportModal({
                el: "div.bb-modal",
                docId: e
            }).show()
        },
        tap: function (e) {
            var n = t(e.target).closest(".doc-instance")[0];
            t.each(this.cards, function (e, t) {
                t.el !== n && t.setTagMode(!1)
            })
        },
        changeFilterDropdown: function (e) {
            var n = t(e.target),
                i = n.closest("li"),
                s = n.closest(".filter-select"),
                a = i.find("label").text();
            s.find("li").removeClass("selected"), i.addClass("selected"), s.find(".current-selection").text(a), s.find(".collapsible-heading").trigger("collapse"), this.changeFilters(e)
        },
        changeFilters: function () {
            var e = parseInt(this.$(".filter-select [name=status]:checked").val()),
                t = this.$(".filter-select [name=sort]:checked").val(),
                n = {
                    owner_only: this.$("#my-docs")[0].checked,
                    status: e,
                    order: t
                };
            this.appState.get("space").filter.set(n)
        },
        updateDropdown: function (e, n) {
            var i;
            this.$(".filter-select [name=" + e + "]").each(function (e, s) {
                var a = s.value === n;
                s.checked = a;
                var o = t(s).closest("li").toggleClass("selected", a);
                a && (i = o)
            });
            var s = i.closest(".filter-select"),
                a = i.find("label").text();
            s.find(".current-selection").text(a)
        },
        updateFilterControls: function (e) {
            var t = (e.get("status") || "all").toString();
            this.updateDropdown("status", t), this.updateDropdown("sort", e.get("order")), this.$("#my-docs")[0].checked = e.get("owner_only")
        },
        updateFilterFromUrl: function () {
            var e = this.appState.get("space").filter;
            this.loadingUrl = !0, window.location.search ? e.parseUrl() : e.set(s.globalData().currentSpace.filter), this.loadingUrl = !1
        },
        tagsChanged: function (e, t) {
            this.setTagsListVisible({
                show: t.length
            })
        },
        filterChanged: function (e) {
            this.gotDocuments.always(n.bind(this.filterDocuments, this, e))
        },
        filterDocuments: function (e) {
            this.cardRenderer && this.cardRenderer.cancel();
            var t = "?" + e.queryString() + "&";
            this.loadingUrl || (Backbone.history.fragment = null, Backbone.history.navigate(t)), Backbone.history.fragment = t, e.saveCookie(), n.invoke(this.cards, "remove");
            var i = this.cards = [],
                s = this.$(".doc-grid");
            this.shownDocuments = n.chain(this.allDocuments.models).filter(e.matchesDocument, e).sortBy(e.sortValue, e).value(), this.cardRenderer = m(15, this.shownDocuments, function (e) {
                ...
                n.each(e, function (e) {
                    ...
                    i.push(n), t.appendChild(n.el)
                }, this), s.append(t)
            }, this).defer(), this.updateFilterControls(e)
        },
        acceptInvite: function (e) {
            ...
            g(e, {
                ...
                var n = a.get(e.article.id, e.article),
                    i = new l({
                        model: n,
                        appState: t.appState,
                        spaceTags: t.appState.get("space").tags
                    });
                t.allDocuments.add(n), t.shownDocuments.push(n), t.cards.unshift(i), t.$(".doc-grid").prepend(i.el)
            }), t.clearInvite(e)
        },
        ...
        clearInvite: function (e) {
            var n = this;
            t(e.target).closest(".invite").addClass("defunct").addClass("closing-invite"), setTimeout(function () {
                n.clearInvites()
            }, 1010)
        },
        clearInvites: function () {
            if (this.$(".closing-invite").remove(), !this.$(".invite").length) {
                var e = this.$(".invites").addClass("closing-invites");
                setTimeout(function () {
                    e.remove()
                }, 1010)
            }
        }
    }), p.mixin(tide.v.DashboardView, h);
    var _ = i.touchEvents ? "touchend" : "click";
    n.each(tide.v.DashboardView.prototype.events, function (e, t, n) {
        0 === t.indexOf("TOUCH_END") && (delete n[t], n[t.replace("TOUCH_END", _)] = e)
    })
}(this, jQuery, _, tide.support, tide.util, tide.m.Document, tide.m.Documents, tide.m.Tags, tide.v.BBView, tide.v.DocumentCardView, tide.v.ManageTagsView, tide.v.DashboardMenu, tide.DisplaySideMenu, Cocktail, tide.m.AppState),
function (e, t, n, i, s, a, o) {
    n.v.AccountPage = i.extend({
        events: {
            "click .bulk-export": "bulkExport"
        },
        initialize: function () {
            this.page = e(document.body).data("page-name")
        },
        bulkExport: function (t) {
            t.preventDefault();
            var n = e(t.target);
            if ("disabled" !== n.attr("disabled")) {
                n.attr("disabled", "disabled").find("input").prop("disabled", !0);
                var i = n.text();
                n.text(o.get("exportButtonProcessing"));
                var s = this;
                e.ajax({
                    url: "/api/v1/request-bulk-export",
                    success: function () {
                        a.show({
                            html: o.get("exportProcessing"),
                            type: "success"
                        }), s.$(".description").hide().attr("aria-hidden", "true"), s.$(".description-success").show().attr("aria-hidden", "false")
                    },
                    error: function (s) {
                        var r = s.responseJSON && s.responseJSON.reason || o.get(["errors", s.status, "notice"]) || o.get("genericError");
                        a.show({
                            html: r,
                            type: "error",
                            timeout: !0
                        }), e(t.target).removeAttr("disabled", "disabled").find("input").prop("disabled", !1), n.text(i)
                    }
                })
            }
        }
    }), t.mixin(n.v.AccountPage, s)
}(jQuery, Cocktail, tide, tide.v.BBView, tide.DisplaySideMenu, tide.c.notifications, tide.m.messages),
function (e, t, n, i) {
    e.v.GenericPage = n.extend({
        initialize: function () {
            this.page = t(document.body).data("page-name")
        }
    }), Cocktail.mixin(e.v.GenericPage, i)
}(tide, jQuery, tide.v.BBView, tide.DisplaySideMenu),
function (e, t, n, i, s, a, o) {
    new n, e(function () {
        var n = e(document.body).is(".tmpl-dash.sect-docs") || e(document.body).is(".tmpl-dash.sect-archive"),
            r = "account" === e(document.body).data("page-name");
        n ? t.c.currentController = new i({
            el: document.body
        }) : r ? (t.c.currentController = new s({
            el: e(".ed-outer")[0]
        }), e("div.delete-account").on("click", "label.delete-account input", function () {
            var e = (t.currentUser.id, new o({
                el: "div.bb-modal",
                action: "/users",
                obj_type: "account",
                callback: function () {
                    e.hide(), window.location.href = "/byebye"
                }
            }));
            return e.show(), !1
        })) : t.c.currentController = new a({
            el: e(".ed-outer")[0]
        }), e("div.publishing").on("click", "a.btn-connect", function () {
            return e(this).hide(), e("#select-a-service").show(), !1
        }).on("click", "input.ico-delete-red", function () {
            var t = e(this).data("pub-id"),
                n = e(this).parent(),
                i = n.closest("ul"),
                s = new o({
                    el: "div.bb-modal",
                    action: "/api/v1/publication/" + t,
                    obj_type: "integration",
                    callback: function () {
                        n.remove(), s.hide(), i.children().length < 1 && i.prev("p").show()
                    }
                });
            return s.show(), !1
            ...
            silent: t.c.currentController instanceof i
        })
    })
}(jQuery, tide, tide.Router, tide.v.DashboardView, tide.v.AccountPage, tide.v.GenericPage, tide.v.DeleteAnythingModal),
function (e, t) {
...
}(this, tide.v.TemplateView), tide.range = {
    getText: function () {},
    setText: function () {},
    wrap: function (e, t, n) {
...
}, tide.v.editor = tide.v.editor || {}, tide.v.editor.selection = {
    get: function (e) {
        function t(e, n) {
        ...
        handleKeydown: function (e) {
            ...
            if (_ && !e.ctrlKey) this._insertText("	"), a = !0;
                ...
                if ((f || m) && (h && !d && o || d && !h && !o)) {
                    ...
                    if (k.start === k.end && k.start > 0)
                        if (o && d) {
                            if (window.getSelection) {
                                ...
                                F.modify ? (F.modify("extend", "backward", "lineboundary"), I = this._getSelection().end) : n.warn("Cannot backspace to line boundary; DOMSelection.modify() is not supported.", !0)
                            }
                        } else if (o && h || !o && d) {
                        ...
                        var D = M.match(/\S+\s*$/),
                            R = D ? D.index : 0;
                        this._setSelection(R, k.start), A = R, I = k.start
                    ...
                    for (var O = this.getMarksInRange(A, I), g = O.length - 1; g > -1; g--) O[g].start > A && (this._directionalIntent = -1), O[g].start = O[g].end = A;
                    ...
                    if (k.start === k.end)
                        if (o && d) {
                            if (window.getSelection) {
                                var F = window.getSelection();
                                F.modify ? (F.modify("extend", "forward", "lineboundary"), A = this._getSelection().start) : n.warn("Cannot delete to line boundary; DOMSelection.modify() is not supported.", !0)
                            }
                        } else if (o && h || !o && d) {
                        var M = this.element.textContent;
                        M = M.slice(k.end);
                        var D = M.match(/^\s*\S+/),
                            L = k.end + (D ? D[0].length : M.length);
                        this._setSelection(k.end, L), A = k.end, I = L
                    } else k.end < this.element.textContent.length && (this._setSelection(k.end, k.end + 1), A = k.end, I = k.end + 1);
                    tide.v.editor.selection.getText().indexOf("\n") > -1 && (this._didChangeLines = !0);
                    for (var O = this.getMarksInRange(A, I), g = O.length - 1; g > -1; g--) O[g].start = O[g].end = A;
                    tide.support.webKit ? (this._doInputCleanup = "delete", this._insertText(" ", 0, 1)) : (this._insertText(""), a = !0), this._directionalIntent = 1
                }
            } else {
                var F, $;
                window.getSelection && (F = window.getSelection(), F.modify && ($ = F.rangeCount && F.getRangeAt(0), F.modify("move", "forward", "lineboundary")));
                var j = this._keydownActiveToken,
                    P = j.length ? j[0].getBoundingClientRect().top : 0,
                    B = Math.floor(tide.v.editor.selection.getCoords().y),
                    H = 10;
                if ($ && (F.removeAllRanges(), F.addRange($)), Math.abs(B - P) <= H) {
                    var U = j.prev(".br")[0];
